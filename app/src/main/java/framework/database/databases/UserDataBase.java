...
import framework.database.daos.DollDao;
 ...
 * @Description
 **/
@Database(version = 1, exportSchema = false,entities = {UserInfo.class})
public abstract class UserDataBase extends RoomDatabase {

    public abstract UserDao getUserDao();

    public static UserDataBase getInstance(Context context) {
        return DataBaseManager.getInstance().getDataBase(context,UserDataBase.class);
    }
